...
1. Product identity is fixed as the kill-review's surviving sentence: a screen-reader-native
   ...
   caliper/datasheet = truth. No precision claims, ever (see PLAN.md §7 embargo list).
...
6. Threshold freeze is real: thresholds.py values are set once at creation (PLAN.md §3)
